    ...
    <Card className="w-full border-border/50 hover:border-accent/50 transition-all duration-300 hover:shadow-lg group bg-white backdrop-blur-sm">
        ...
        <div className="flex flex-col gap-3 sm:gap-4">
          <div className="space-y-3 sm:space-y-4 flex-1">
            <div className="flex items-start gap-3">
              <div className="p-2 sm:p-2.5 bg-accent/10 rounded-xl flex-shrink-0 mt-1">
                <Building className="w-4 h-4 sm:w-5 sm:h-5 text-accent" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="text-lg sm:text-xl md:text-2xl font-heading font-semibold text-foreground group-hover:text-accent transition-colors duration-300 leading-tight mb-2 sm:mb-3">
                  {data.role}
                </h3>
      ...
      <CardContent className="space-y-4 sm:space-y-6">
        ...
        {data.project && (
          <div className="space-y-3 sm:space-y-4">
            {data.project.description && (
              <div className="p-3 sm:p-4 bg-muted/30 rounded-xl border border-border/50">
                <div className="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <Award className="w-3 h-3 sm:w-4 sm:h-4 text-accent mt-0.5 flex-shrink-0" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
              {data.project.client && (
                <div className="p-3 sm:p-4 bg-background rounded-xl border border-border/50 hover:border-accent/30 transition-colors duration-200">
        ...
        <div className="pt-3 sm:pt-4 border-t border-border/50">
          <button className="flex items-center gap-2 text-xs sm:text-sm text-accent hover:text-accent/80 transition-colors duration-300 group/btn font-medium">
            <span>View Project Details</span>
            <ArrowUpRight className="w-3 h-3 sm:w-4 sm:h-4 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform duration-300" />
          </button>
        </div>
      </CardContent>
    </Card>
